...
?>
<!-- Editar -->
<div class="modal fade" id="edit_<?php echo $row['idpermiso']; if(isset($b)){ echo $b;}  ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="editadrol.php?id=<?php echo $row['idpermiso']; ?>  & b=<?php if(isset($b)){ echo $b;}  ?>">
...
<!-- Eliminar -->
<div class="modal fade" id="delete_<?php echo $row['idpermiso']; if(isset($b)){ echo $b;} ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> Cancelar</button>
                <a href="deleteadrol.php?id=<?php echo $row['idpermiso']; ?> & b=<?php if(isset($b)){ echo $b;}  ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Si</a>
