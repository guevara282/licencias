...
?>
<!-- Editar -->
<div class="modal fade" id="edit_<?php echo $row['idrh']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="editrh.php?id=<?php echo $row['idrh']; ?>">
...
<!-- Eliminar -->
<div class="modal fade" id="delete_<?php echo $row['idrh']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> Cancelar</button>
                <a href="deleterh.php?id=<?php echo $row['idrh']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Si</a>
            </div>
