...
$ctido="SELECT * from categoria where estado='1'";
$ctd=mysqli_query($conexion,$ctido);

$fgt="SELECT * from categoria where estado='0'";
...
<div class="container">
	...
	<h1 class="page-header text-center">CATEGORIA DE LICENCIA DE CONDUCCION</h1>
	<div class="row">
		<div class="col-sm-12">
						...
						try{	
						    ...
						    foreach ($db->query($sql) as $row) {
						    	...
						    	<tr>
									...
									<td><?php 
                                    $ge=$row['idcategoria'];
									$tiar="select * from tipovehiculo where idtipovehiculo in (select idtipovehiculo from categoria where idcategoria=$ge)";
									foreach($db->query($tiar) as $tyr){
                                     echo $tyr['nombre'];
									}
									?></td>
						    		<td>
						    			<a href="#edit_<?php echo $row['idcategoria']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="fa fa-edit"></span> Editar</a>
						    			<a href="#delete_<?php echo $row['idcategoria']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fa fa-trash"></span> Eliminar</a>
						    		</td>
						    		<?php include('edit_delete_modalcat.php'); ?>
						    	</tr>
						    	<?php 
						    }
						}
