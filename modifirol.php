...
<div class="container">
	<br><br><br>
	<h1 class="page-header text-center">MODIFICAR ROL DE USUARIO</h1>
	<br><br><br>
	<div class="row">
		<div class="col-sm-12">
		<?php $a=0; ?>
			<!-- <a href="#addnew" class="btn btn-primary" data-toggle="modal"><span class="fa fa-plus"></span> Nuevo</a> -->
			<form action="modifirol.php" class="form-inline my-2 my-lg-0" method="POST" >
						...
						try{
							...
							if(isset($_POST['prueba'])){
								...
								if(empty($b)){
									...
									$sql = "SELECT * FROM usuario where numerodocumento=$b";
								}
						    ...
						    foreach ($db->query($sql) as $row) {
						    	...
						    	<tr>
									...
									echo $f['nombre'];}?></td>
						    		<td>
						    			<a href="#edit_<?php echo $row['numerodocumento']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="fa fa-edit"></span> Editar</a>
						    			
						    		</td>
						    		<?php include('edit_delete_modalrol.php'); ?>
						    	</tr>
						    	<?php 
						    }
						}
