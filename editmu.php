...
*/
	...
	if(isset($_POST['edit'])){
		...
		try{
			$id = $_GET['id'];
			$firstname = $_POST['curso'];
			/* $lastname = $_POST['lastname'];
			$address = $_POST['address']; */

			/* $sql = "UPDATE usuario SET idcurso= '$firstname' WHERE numerodocumento = '$id'"; */
			$sql="INSERT INTO cursousuario(numerodocumento, idcurso, fechamatricula) VALUES ('$id', '$firstname', CURRENT_TIMESTAMP) ";
