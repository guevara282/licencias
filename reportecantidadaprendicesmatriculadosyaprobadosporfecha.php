...
<div class="contain">
      <br><br><br>
      <form action="raprendicesquehancursadoyaprobadoporfecha.php" method="post">
      <h2>Reporte cantidad de aprendices que han aprobado y reprobado en un rango de fecha</h2>
      <br><br>
        <form action="">

        <p>
            <label for="" class="form-control">Fecha inicio</label>
            <input class="form-control" type="date" name="fi" required>
          </p>
          <p>
            <label for="" class="form-control" require>Fecha fin</label>
            <input class="form-control" type="date" name="ff" required>
          </p>
