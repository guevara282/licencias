    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            	<center><h4 class="modal-title" id="myModalLabel">Agregar CATEGORIA DE LICENCIA</h4></center>
			...
			<form method="POST" action="addcat.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
					<select name="tipovehiculo" class="form-control" required="required">
            <?php 
            $sql="SELECT * FROM tipovehiculo";
        
            foreach ($db->query($sql) as $valores) { ?>
            <option value="<?php echo $valores['idtipovehiculo']; ?>"><?php echo $valores['nombre']; ?> </option> 
            <?php }
            ?>
            </select>
					</div>
