...
*/
	...
	if(isset($_GET['id'])){
		...
		$db = $database->open();
		try{
			$sql = "DELETE FROM tiposangre WHERE idtiposangre = '".$_GET['id']."'";
			// declaración if-else en la ejecución de nuestra consulta
			$_SESSION['message'] = ( $db->exec($sql) ) ? 'Tipo de sangre eliminado correctamente' : 'Ocurrió un error. No se pudo eliminar al miembro';
		}
