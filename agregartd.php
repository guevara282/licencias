...
<div class="container">
	...
	<h1 class="page-header text-center">TIPO DE DOCUMENTO</h1>
	<div class="row">
		<div class="col-sm-12">
						...
						try{	
						    ...
						    foreach ($db->query($sql) as $row) {
						    	...
						    	<tr>
						    		...
						    		<td>
						    			<a href="#edit_<?php echo $row['idtipodocumento']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="fa fa-edit"></span> Editar</a>
						    			<a href="#delete_<?php echo $row['idtipodocumento']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fa fa-trash"></span> Eliminar</a>
						    		</td>
