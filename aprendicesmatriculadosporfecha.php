...
<div class="contain">
<br><br><br>
      <form action="raprendicesmatriculadosporfecha.php" method="post">
      <h2>Reporte cantidad de aprendices matriculados en un rango de fecha</h2>
      <br><br>
        <form action="">

        <p>
            <label for="" class="form-control">Fecha inicio</label>
            <input class="form-control" type="date" name="fein" required>
          </p>
          <p>
            <label for="" class="form-control">Fecha fin</label>
            <input class="form-control" type="date" name="fefi" required>
          </p>
          <p class="full-width">
          <br><br>
