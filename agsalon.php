...
<div class="container">
<br><br><br>
	<h1 class="page-header text-center">Administrar salones</h1>
	<div class="row">
		<div class="col-sm-12">
			<a href="#addnew" class="btn btn-primary" data-toggle="modal"><span class="fa fa-plus"></span> Nuevo salón</a>
            <?php 
                session_start();
						...
						try{	
						    ...
						    foreach ($db->query($sql) as $row) {
						    	...
						    	<tr>
						    		...
						    		<td>
						    			<a href="#edit_<?php echo $row['idsalon']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="fa fa-edit"></span> Editar</a>
						    			<a href="#delete_<?php echo $row['idsalon']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fa fa-trash"></span> Eliminar</a>
						    		</td>
						    		<?php include('edit_delete_modalsalon.php'); ?>
						    	</tr>
						    	<?php 
						    }
						}
...
<?php include('add_modalsalon.php'); ?>
