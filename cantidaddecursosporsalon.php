...
<div class="contain">
  <br><br><br>
      <form action="rcursosrealizadosenunsalon.php" method="post">
      <h2>Reporte cantidad de cursos que se están realizando en una sala</h2>
      <br><br>
        <form action="">
          <p>
          <label for="">Seleccione el salón</label>
            <br>
            <select name="salon" class="form-control" required>
            <option>Seleccione:</option>
            <?php 
            $q=mysqli_query($conexion, "SELECT * FROM salon");
