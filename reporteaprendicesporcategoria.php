...
<div class="contain">
      <br><br><br>
      <form action="raprendicesporcategoria.php" method="post">
      <h2>Generar reporte de aprendices inscritos a una categoria</h2>
      <br><br>
        <form action="">

          <p>
          <label for=""class = "form-control" >Seleccione el tipo de vehiculo</label>
          ...
          <p>
          <label for=""class = "form-control" >Seleccione La categoria</label>
	...
	$(document).ready(function(){
		$('#id_deparatamento').on('change', function(){
				if($('#id_deparatamento').val() == ""){
					...
					$('#municipio').load('ajaxaprendicescategoria.php?id_deparatamento=' + $('#id_deparatamento').val());	
