...
<div class="container">
	<br><br><br>
	<h1 class="page-header text-center">ARCHIVOS FINANCIEROS</h1>
	<div class="row">
		<div class="col-sm-12">
			<a href="#addnew" class="btn btn-primary" data-toggle="modal"><span class="fa fa-plus"></span> Nuevo archivo</a>
            <?php 
                session_start();
			...
			<table class="table table-bordered table-striped" style="margin-top:20px;">
				...
				<tbody>
					<?php
    					...
    					$db = $database->open();
						try{	
						    $sql = "select * from documento where numerodocumento=$varse";
						    foreach ($db->query($sql) as $row) {
							 ...
							 echo $row['nombre'];
                                   ...
                                   echo $row['url'];
									...
									<a href="#delete_<?php echo $row['iddocumento']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fa fa-trash"></span> Eliminar</a>
...
<?php include('add_modalarcfinan.php'); ?>
