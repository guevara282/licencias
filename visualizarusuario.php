...
<div class="container">
	...
	<div class="row">
		...
		<?php $a=0; ?>
			...
			<form action="visualizarusuario.php" class="form-inline my-2 my-lg-0" method="POST" >
			<!-- <input type="text" name="prueba" placeholder= "" > -->
		      <input class="form-control mr-sm-2" type="text" name="prueba" placeholder="Número de documento">
...
<td>
<?php
$ss="select * from curso where idcurso in (select idcurso from cursousuario where numerodocumento=$nu)";
foreach($db->query($ss) as $tt){
echo $tt['nombre'];
echo "<br>";
